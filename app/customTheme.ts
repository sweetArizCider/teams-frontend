...
export const customTheme = createTheme({
  button: {
    base: 'relative flex items-center justify-center rounded-lg text-center font-medium focus:outline-none focus:ring-4 hover:cursor-pointer',
    disabled: 'pointer-events-none opacity-50',
    fullSized: 'w-full',
    grouped:
      'rounded-none border-l-0 first:rounded-s-lg first:border-l last:rounded-e-lg focus:ring-2',
    pill: 'rounded-full hover:cursor-pointer',
    size: {
      xs: 'h-8 px-3 text-xs',
      sm: 'h-9 px-3 text-sm',
    ...
    color: {
      default:
        'bg-primary-700 text-white hover:cursor-pointer hover:bg-primary-800 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800',
      alternative:
        'border border-gray-200 hover:cursor-pointer bg-white text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700',
      blue: 'bg-blue-700 text-white hover:cursor-pointer hover:bg-blue-800 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800',
      cyan: 'bg-cyan-700 text-white hover:cursor-pointer hover:bg-cyan-800 focus:ring-cyan-300 dark:bg-cyan-600 dark:hover:bg-cyan-700 dark:focus:ring-cyan-800',
      dark: 'bg-gray-800 text-white hover:cursor-pointer hover:bg-gray-900 focus:ring-gray-300 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700',
      gray: 'bg-gray-700 text-white hover:cursor-pointer hover:bg-gray-800 focus:ring-gray-300 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800',
      green:
